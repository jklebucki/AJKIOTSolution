...
def after_build(source, target, env):
    ...
    destination_dir = os.path.abspath(os.path.join(project_dir, '..', '..', '..', 'AJKIOT.Api', 'FirmwareFiles', 'OpenTimer'))
    destination_path = os.path.join(destination_dir, "FirmwareOpenTimer.bin")
